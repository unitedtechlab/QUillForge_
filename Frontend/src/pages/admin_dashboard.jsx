...
//     console.log("CREATE BLOG RENDER");
...
//       case "manage":    return <ManageBlogsPage />;
//       case "analytics": return <PlaceholderPage  title="Analytics"  icon={<BarChart3 size={24}/>}  desc="Detailed performance charts coming soon."/>;
//       case "settings":  return <PlaceholderPage  title="Settings"   icon={<Settings size={24}/>}   desc="Profile and account settings coming soon."/>;
